		            ...
		            <div class="carousel-testimony owl-carousel">
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  <div class="user-img mb-5" style="background-image: url(https://jaipur.manipal.edu/content/dam/manipal/muj/images/2021/profilephoto2021/FOE/SCIT/computerscienceeng/Sandeep_Chaurasia.jpg)">
		                  ...
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Dr Sandeep Chaurasia is Professor in Department of Computer Science and Engineering, School of Computing & Information Technology at Manipal University Jaipur. He is also serving as:

 

M.Tech (CSE) Coordinator.
Department Coordinator Accreditation.
Member of Department Research Committee.
Member of Board of Studies (BoS)
Department Placement Coordinator
Member Budgetary Committee.  
Nodal officer for Florida International University.</p>
		                    <p class="name">Dr Sandeep Chaurasia</p>
		                    <span class="position">Professor and Head</span>
		                  </div>
		                </div>
		              </div>
		              <div class="item">
		                <div class="testimony-wrap d-flex">
		                  <div class="user-img mb-5" style="background-image: url(https://jaipur.manipal.edu/content/dam/manipal/muj/images/2021/profilephoto2021/FOE/SCIT/computerscienceeng/Shikha_Mundra.jpg)">
		                    <span class="quote d-flex align-items-center justify-content-center">
		                      <i class="icon-quote-left"></i>
		                    </span>
		                  </div>
		                  <div class="text ml-md-4">
		                    <p class="mb-5">Ms.Shikha Mundra is working as Assistant Professor (Senior Scale) in the Department of Computer Science and Engineering, School of Computing and Information Technology at Manipal University, Jaipur.</p>
		                    <p class="name">Ms Shikha Mundra</p>
